			...
			if ( is_wp_error( $result ) ) {
				...
				<div id="signup-welcome">
					...
					<p>
						...
						<?php if ( $result['password_hash'] ): ?>
							<?php esc_html_e( 'Set at registration.', 'gravityformsuserregistration' ); ?>
						<?php else: ?>
							<a href="<?php echo gf_user_registration()->get_set_password_url( $user ); ?>"><?php esc_html_e( 'Set your password.' ); ?></a>
						<?php endif; ?>
					</p>
				</div>
